...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2026 at 03:37 PM
...
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `role`, `phone`, `status`, `created_at`, `updated_at`) VALUES
(1, 'System Administrator', 'admin@hostel.com', '$2y$10$ljsv01iZmWT/nhdhmIKApeonFeBXUdwB3V/HzIWlDuM8QZRIOD4IK', 'admin', '0000000000', 'active', '2026-07-23 12:33:31', '2026-07-23 12:57:54');
...
ALTER TABLE `allocations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_alloc_student` (`student_id`),
...
ALTER TABLE `complaints`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_comp_student` (`student_id`),
...
ALTER TABLE `visitors`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_vis_student` (`student_id`),
...
--
ALTER TABLE `complaints`
  ADD CONSTRAINT `fk_comp_student` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `visitors`
  ADD CONSTRAINT `fk_vis_student` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"hostel_management\",\"table\":\"users\"}]');
...
('root', '2026-07-23 13:36:36', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"en_GB\",\"NavigationWidth\":0}');
